...
```shell
docker build . -t com.shopbee/shopbee-category-service:1.0.0
```
...
```shell
docker run -d -p 8080:8080 --name shopbee-category-service com.shopbee/shopbee-category-service:1.0.0
```

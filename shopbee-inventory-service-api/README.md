# shopbee-inventory-service-api

## Description

API specification library for shopbee-inventory-service-api.
...
```
shopbee-inventory-service-api-spec.yaml
```
...
3. Package into a JAR file: `build/libs/shopbee-inventory-service-api-1.0.0.jar`

### Generated Code

The build process generates:
- **Models**: POJOs with validation annotations in `com.shopbee.inventory.entity` package
- **API Interfaces**: JAX-RS interfaces in `com.shopbee.inventory.boundary.api` package

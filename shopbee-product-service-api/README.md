# shopbee-product-service-api

## Description

API specification library for shopbee-product-service-api.
...
```
shopbee-product-service-api-spec.yaml
```
...
3. Package into a JAR file: `build/libs/shopbee-product-service-api-1.0.0.jar`

### Generated Code

The build process generates:
- **Models**: POJOs with validation annotations in `com.shopbee.product.entity` package
- **API Interfaces**: JAX-RS interfaces in `com.shopbee.product.boundary.api` package

...
```shell
docker build . -t com.shopbee/shopbee-product-service:1.0.0
```
...
```shell
docker run -d -p 8080:8080 --name shopbee-product-service com.shopbee/shopbee-product-service:1.0.0
```

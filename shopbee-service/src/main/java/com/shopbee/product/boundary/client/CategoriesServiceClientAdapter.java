...
import com.shopbee.common.client.BaseIntervalServiceClientAdapter;
...
@ApplicationScoped
public class CategoriesServiceClientAdapter extends BaseIntervalServiceClientAdapter {
    ...
    protected String getServiceName() {
        return RestClientConstants.CATEGORIES_SERVICE;
    }
}

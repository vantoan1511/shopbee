...
public class UserServiceImpl implements UserService {
    ...
    private Address findAddressByUserIdAndAddressId(String tenantId, String userId, String addressId) {
        ...
        if (address == null) {
            ...
            throw new NotFoundException("ADDRESS_NOT_FOUND", "Address not found: " + addressId);
        }
    ...
    private void validateNewUsername(String tenantId, String username) {
        if (isUsernameExisted(tenantId, username)) {
            throw new ConflictDataException("USERNAME_EXISTED", "Username already existed: " + username);
        }
    }
    ...
    private NotFoundException userNotFoundException(String userId) {
        return new NotFoundException("USER_NOT_FOUND", "User not found: " + userId);
    }

    private ConflictDataException emailExistedException(String email) {
        return new ConflictDataException("EMAIL_EXISTED", "Email linked to another user: " + email);
    }

    private ConflictDataException phoneExistedException(String countryCode, String number) {
        return new ConflictDataException("PHONE_EXISTED", "Phone linked to another user: " + countryCode + number);
    }
}

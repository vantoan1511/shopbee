# shopbee-tenant-service-api

## Description

API specification library for shopbee-tenant-service-api.
...
```
shopbee-tenant-service-api-spec.yaml
```
...
3. Package into a JAR file: `build/libs/shopbee-tenant-service-api-1.0.0.jar`

### Generated Code

The build process generates:
- **Models**: POJOs with validation annotations in `com.shopbee.tenant.entity` package
- **API Interfaces**: JAX-RS interfaces in `com.shopbee.tenant.boundary.api` package

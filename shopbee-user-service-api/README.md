...
API specification library for shopbee-user-service-api.
...
```
shopbee-user-service-api-spec.yaml
```
...
3. Package into a JAR file: `build/libs/shopbee-user-service-api-{{version}}.jar`

### Generated Code

The build process generates:
- **Models**: POJOs with validation annotations in `{{groupId}}.model` package
- **API Interfaces**: JAX-RS interfaces in `{{groupId}}.boundary.api` package

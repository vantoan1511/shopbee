...
The implementation of the shopbee-user-service project.
...
```shell
docker build . -t com.shopbee/shopbee-user-service:1.0.0
```
...
```shell
docker run -d -p 8080:8080 --name shopbee-user-service com.shopbee/shopbee-user-service:1.0.0
```
